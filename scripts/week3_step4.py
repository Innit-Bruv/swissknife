...
# ── Blade 2: Harmlessness (unchanged) ────────────────────────────────────────
...
# ── Blade 4: Informativeness — CHANGE 1: stronger NLI model ──────────────────
...
# ── Helper: get draft model probability for a token ───────────────────────────
...
# CHANGE 2: weighted combination for safety — 0.7 safety + 0.3 draft probability
def score_safety(context_text, span_text, input_ids=None, first_token_id=None):
    ...
    # Mix with draft probability to keep response grounded
...
# CHANGE 3: max_new_tokens increased to 150 (was 80)
...
# ── Same 4 prompts for direct comparison with EXP-05 ─────────────────────────
prompts = [
...
for prompt in prompts:
    ...
    for blade_name, score_fn in blades:
        print(f"\n[SPAN TOURNAMENT K=8 - {blade_name} blade]")
